...
export default function SubjectCard({ title, grade, lessonsCount, imageSrc, status = "APPROVED" }: SubjectCardProps) {
  ...
  return (
    <div className="rounded-xl border border-gray-200 bg-white shadow-sm max-w-[360px] mx-auto w-full">
      <div className="relative h-[180px] w-full overflow-hidden rounded-t-xl">
        <Image src={imageSrc} alt={title} fill sizes="(min-width: 1024px) 33vw, 100vw" className="object-cover" />
      ...
      <div className="p-4">
        ...
        <div className="mt-3 flex items-center justify-end gap-3 text-gray-400">
          ...
          <button aria-label="Edit" className="hover:text-gray-600">
