    ...
    <div className="space-y-6">
      ...
      <div className="flex items-start justify-between">
        ...
        <div className="hidden gap-3 sm:flex">
          ...
          <button onClick={() => router.push(`/lessons/create/quiz-assessment/questions?title=${encodeURIComponent(quizTitle || "Introduction to Algebra")}`)} className="rounded-lg bg-emerald-600 px-4 py-2 text-sm font-semibold text-white hover:bg-emerald-700">Next</button>
        </div>
      </div>
      ...
      <div className="mx-auto w-full max-w-4xl space-y-6">
        ...
        <div className="flex gap-3 sm:hidden">
          ...
          <button onClick={() => router.push(`/lessons/create/quiz-assessment/questions?title=${encodeURIComponent(quizTitle || "Introduction to Algebra")}`)} className="flex-1 rounded-lg bg-emerald-600 px-4 py-2 text-sm font-semibold text-white hover:bg-emerald-700">Next</button>
        </div>
